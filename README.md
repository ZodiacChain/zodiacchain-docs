...
* **[MVP Demo Script](grant/mvp-demo-script.md)**: Repeatable demo runbook for reviewers, partners, and community calls.
...
3.  **Deterministic Logic:** Outcomes like the *Exact Celestial Number (01-60)* and *Terrestrial Mapping* are planned to be derived through open, auditable smart contract code.
4.  **Visible Protection:** Concentration caps and solvency checks are planned on-chain protections for protocol liquidity.
